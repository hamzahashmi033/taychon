              ...
              <div className="accordion   bord">
                <div className="item active wow fadeInUp" data-wow-delay=".1s">
                  <div onClick={openAccordion} className="title">
                    <h6 className="text-black">Discovery & Research</h6>
                    <span className="ico ti-plus text-black"></span>
                  </div>
                ...
                <div className="item wow fadeInUp" data-wow-delay=".3s">
                  <div onClick={openAccordion} className="title">
                    <h6 className="text-black">Planning & Strategy</h6>
                    <span className="ico ti-plus text-black"></span>
                  </div>
                  <div className="accordion-info">
                    <p className="text-black">
                ...
                <div className="item wow fadeInUp" data-wow-delay=".5s">
                  <div onClick={openAccordion} className="title">
                    <h6 className="text-black">UI/UX Design</h6>
                    <span className="ico ti-plus text-black"></span>
                  </div>
                  <div className="accordion-info">
                    <p className="text-black">
                ...
                <div className="item wow fadeInUp" data-wow-delay=".5s">
                  <div onClick={openAccordion} className="title">
                    <h6 className="text-black">Development & Coding</h6>
                    <span className="ico ti-plus text-black"></span>
                  </div>
                  <div className="accordion-info">
                    <p className="text-black">
                ...
                <div className="item wow fadeInUp" data-wow-delay=".5s">
                  <div onClick={openAccordion} className="title">
                    <h6 className="text-black">Testing & Quality Assurance</h6>
                    <span className="ico ti-plus text-black"></span>
                  </div>
                  <div className="accordion-info">
                    <p className="text-black">
                ...
                <div className="item wow fadeInUp" data-wow-delay=".5s">
                  <div onClick={openAccordion} className="title">
                    <h6 className="text-black">Deployment & Launch</h6>
                    <span className="ico ti-plus text-black"></span>
                  </div>
                  <div className="accordion-info">
                    <p className="text-black">
                ...
                <div className="item wow fadeInUp" data-wow-delay=".5s">
                  <div onClick={openAccordion} className="title">
                    <h6 className="text-black">Monitoring & Optimization</h6>
                    <span className="ico ti-plus text-black"></span>
                  </div>
                  <div className="accordion-info">
                    <p className="text-black">
                ...
                <div className="item wow fadeInUp" data-wow-delay=".5s">
                  <div onClick={openAccordion} className="title">
                    <h6 className="text-black">Maintenance & Support</h6>
                    <span className="ico ti-plus text-black"></span>
                  </div>
                  <div className="accordion-info">
                    <p className="text-black">
