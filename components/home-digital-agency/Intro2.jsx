              ...
              <div className="accordion   bord">
                <div className="item active wow fadeInUp " data-wow-delay=".1s">
                  <div onClick={openAccordion} className="title">
                    <h6 className="p">Discovery & Research</h6>
                    <span className="ico ti-plus p"></span>
                  </div>
                ...
                <div className="item wow fadeInUp" data-wow-delay=".3s">
                  <div onClick={openAccordion} className="title">
                    <h6 className="p">Planning & Strategy</h6>
                    <span className="ico ti-plus p"></span>
                  </div>
                  <div className="accordion-info">
                    <p className="p">
                ...
                <div className="item wow fadeInUp" data-wow-delay=".5s">
                  <div onClick={openAccordion} className="title">
                    <h6 className="p">UI/UX Design</h6>
                    <span className="ico ti-plus p"></span>
                  </div>
                  <div className="accordion-info">
                    <p className="p">
                ...
                <div className="item wow fadeInUp" data-wow-delay=".5s">
                  <div onClick={openAccordion} className="title">
                    <h6 className="p">Development & Coding</h6>
                    <span className="ico ti-plus p"></span>
                  </div>
                  <div className="accordion-info">
                    <p className="p">
                ...
                <div className="item wow fadeInUp" data-wow-delay=".5s">
                  <div onClick={openAccordion} className="title">
                    <h6 className="p">Testing & Quality Assurance</h6>
                    <span className="ico ti-plus p"></span>
                  </div>
                  <div className="accordion-info">
                    <p className="p">
                ...
                <div className="item wow fadeInUp" data-wow-delay=".5s">
                  <div onClick={openAccordion} className="title">
                    <h6 className="p">Deployment & Launch</h6>
                    <span className="ico ti-plus p"></span>
                  </div>
                  <div className="accordion-info">
                    <p className="p">
                ...
                <div className="item wow fadeInUp" data-wow-delay=".5s">
                  <div onClick={openAccordion} className="title">
                    <h6 className="p">Monitoring & Optimization</h6>
                    <span className="ico ti-plus P"></span>
                  </div>
                  <div className="accordion-info">
                    <p className="P">
                ...
                <div className="item wow fadeInUp" data-wow-delay=".5s">
                  <div onClick={openAccordion} className="title">
                    <h6 className="P">Maintenance & Support</h6>
                    <span className="ico ti-plus P"></span>
                  </div>
                  <div className="accordion-info">
                    <p className="P">
