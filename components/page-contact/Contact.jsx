          ...
          <div className="col-lg-4 valign">
            <div className="sec-head info-box full-width md-mb80">
              ...
              <div className="morinfo mt-50 pb-30 bord-thin-bottom">
                <h6 className="mb-15 p">Address</h6>
                <p className='p'>950 Tower Ln, Foster City, CA 94404</p>
              </div>
              <div className="morinfo mt-30 pb-30 bord-thin-bottom">
                <h6 className="mb-15 p">Email</h6>
                <p className='p'>info@taychon.com</p>
              </div>

              <div className="social-icon mt-50 p">
                <a href="#0">
                ...
                <div className="controls row">
                  ...
                  <div className="col-12">
                    ...
                    <div className="mt-30">
                      ...
                      >
                        <span className="text p">Let&lsquo;s Talk</span>
                      </button>
                    </div>
                  </div>
                </div>
